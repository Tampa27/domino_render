...
import logging
from dominoapp.utils.checktables import automatic_move_in_game, automatic_restar_game, automatic_tournament, automatic_exit_player, automatic_clear_game
...
@shared_task(name="task_expulsar_jugadores")
def task_expulsar_jugadores():
    """Expulsa jugadores inactivos o que no tengan dinero suficiente para jugar en esa mesa."""

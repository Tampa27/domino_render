...
class PaymentRequest:
    ...
    @staticmethod
    def validate_promotion_movies(request):
        is_valid = False
        message = None
        status_response = None
        ...
        validators = {
            "coins": RequestValidator.validate_numeric,
            "token": RequestValidator.validate_text,
    ...
    @staticmethod
    def validate_marketin_promotion(request):
        is_valid = False
        message = None
        status_response = None
    ...
    @staticmethod
    def validate_payment_google(request):
        is_valid = False
        message = None
        status_response = None
        ...
        validators = {
            "coins": RequestValidator.validate_numeric,
            "pay": RequestValidator.validate_numeric,
            "token": RequestValidator.validate_text,
            "player_id": RequestValidator.validate_numeric
        }
